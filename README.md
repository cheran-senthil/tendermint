...
Records](https://github.com/torusresearch/tendermint/tree/master/docs/architecture).

Learn more by reading the code and comparing it to the
[specification](https://github.com/torusresearch/tendermint/tree/master/docs/spec).
