...
LD_FLAGS = -X github.com/torusresearch/tendermint/version.GitCommit=`git rev-parse --short=8 HEAD` -s -w
...
draw_deps:
	...
	@goviz -i github.com/torusresearch/tendermint/cmd/tendermint -d 3 | dot -Tpng -o dependency-graph.png
...
rpc-docs:
	...
	godoc2md -template rpc/core/doc_template.txt github.com/torusresearch/tendermint/rpc/core | grep -v -e "pipe.go" -e "routes.go" -e "dev.go" | sed 's,/src/target,https://github.com/torusresearch/tendermint/tree/master/rpc/core,' >> $(DESTINATION)
