...
import (
	...
	"github.com/torusresearch/tendermint/libs/fail"
	...
	cstypes "github.com/torusresearch/tendermint/consensus/types"
	tmevents "github.com/torusresearch/tendermint/libs/events"
...
func (cs *ConsensusState) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/torusresearch/tendermint/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://github.com/torusresearch/tendermint/issues/3406
...
func (cs *ConsensusState) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 		(https://github.com/torusresearch/tendermint/issues/3839).
