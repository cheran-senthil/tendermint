...
[here](https://github.com/torusresearch/tendermint/wiki/Setting-GOPATH) for
more info.

Then run

```
go get github.com/torusresearch/tendermint
...
human-readable](https://github.com/torusresearch/tendermint/issues/1794).
