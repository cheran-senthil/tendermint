...
[lite](https://github.com/torusresearch/tendermint/tree/master/lite) package. This
...
rules](https://github.com/torusresearch/tendermint/blob/master/docs/spec/blockchain/blockchain.md#validation)
to each block.
...
[here](https://github.com/torusresearch/tendermint/blob/master/docs/spec/consensus/light-client.md).
