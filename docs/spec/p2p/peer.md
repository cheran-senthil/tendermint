...
For details on peer discovery, see the [peer exchange (PEX) reactor doc](https://github.com/torusresearch/tendermint/blob/master/docs/spec/reactors/pex/pex.md).
