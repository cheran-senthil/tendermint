...
REPO=github.com/torusresearch/tendermint
go get $REPO
cd $GOPATH/src/$REPO
...
old_ansible_file=$GOPATH/src/github.com/torusresearch/tendermint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
