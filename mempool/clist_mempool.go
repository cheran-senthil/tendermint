...
import (
	...
	auto "github.com/torusresearch/tendermint/libs/autofile"
	"github.com/torusresearch/tendermint/libs/clist"
...
func (mem *CListMempool) Update(
	...
	for i, tx := range txs {
		...
		// Mempool after:
		//   100
		// https://github.com/torusresearch/tendermint/issues/3322.
		if e, ok := mem.txsMap.Load(txKey(tx)); ok {
