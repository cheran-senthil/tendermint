...
// Examples
//
// - [Tendermint](https://github.com/torusresearch/tendermint/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/torusresearch/tendermint/blob/master/tools/tm-monitor/rpc.go)
package rpc
